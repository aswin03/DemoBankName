...
//			if (httpSession.getAttribute("customerId") != null) {
				 ...
				 * 
				 * it scans the packages/classes for which the base package
				 * provided is 'com.edubank' then it returns the object of
				 * ApplicationContext
				 * 
				 * ApplicationContext holds the objects created by spring
				 * framework
				 */
...
//			if (httpSession.getAttribute("customerId") != null) {
	...
	public ModelAndView customerChangePassword(
		 ...
		 * ApplicationContext holds the objects created by spring framework
		 */
		CustomerLoginService loginService = (CustomerLoginService) ContextFactory
				.getContext().getBean("customerLoginService");
		...
		try {
			if (httpSession.getAttribute("customerId") != null) {
				...
				loginService.changeCustomerPassword(customerLogin);
	...
	public ModelAndView getAccountTransactionsForDateRange(
		...
		try {
			if (httpSession.getAttribute("customerId") != null) {
				...
				TransactionService service = (TransactionService) ContextFactory
						.getContext().getBean("transactionService");
				...
				List<Transaction> transactionsList = service
