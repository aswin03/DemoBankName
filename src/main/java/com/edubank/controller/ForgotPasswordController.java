...
public class ForgotPasswordController 
{
	...
	public ModelAndView forgotPassword(@RequestParam String emailId) {
		...
		try 
		{
			...
			ForgotPasswordService forgotPasswordService = (ForgotPasswordService) ContextFactory
					.getContext().getBean("forgotPasswordService");
			 ...
			 * is 'com.edubank' then it returns the object of ApplicationContext
			 * 
			...
			SecurityQuestionService securityQuestionService = (SecurityQuestionService) ContextFactory.getContext()
	...
	public ModelAndView generateResetPasswordView(@RequestParam("emailId") String emailId, @RequestParam("secQ") String secQ,
		...
		try
		{
			...
			/* getContext() method of ContextFactory class parses the SpringConfig
			 * class and using @ComponentScan,
			 * 
			...
			@RequestParam("confirmNewPwd") String confirmNewPassword, HttpServletResponse response) 
	{
		...
		try 
		{
			 ...
			 * ApplicationContext holds the objects created by spring framework
			 **/
			ForgotPasswordService service = (ForgotPasswordService) ContextFactory
					.getContext().getBean("forgotPasswordService");
			
			// Resetting the password for the given email id by calling service method 
			service.resetPassword(emailId, newPassword, confirmNewPassword);
