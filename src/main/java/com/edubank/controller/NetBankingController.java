...
public class NetBankingController {
	...
	public String payByNetBanking(String remarks, HttpSession httpSession) {
		...
		try
		{
			redirectTo = "redirect:"+this.protocol+"//" + this.host + ":" + this.port + "/" + "#/"
					+ this.requestPage;
			...
			NetBankingService netBankingService = (NetBankingService) ContextFactory
					.getContext().getBean("netBankingService");
